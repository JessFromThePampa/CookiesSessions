...
if (isset($_SESSION['login'])){
  $loginOk = '<br /> Welcome back '.$_SESSION['login'];
  $loginOk .= '<br /><a href="logout.php"class="btn btn-danger btn-lg" role="button">Logout</a>';
}else {
...
if (isset($_GET['add_to_cart'])){
    ...
    if($_GET['add_to_cart'] === '46'){
        setcookie($_GET['add_to_cart'], "Pecan nuts", time() + 900);
    }elseif($_GET['add_to_cart'] === '36'){
        setcookie($_GET['add_to_cart'], "Chocolate chips", time() + 900);
    }elseif($_GET['add_to_cart'] === '58'){
        setcookie($_GET['add_to_cart'], "Chocolate cookie", time() + 900);
    }elseif($_GET['add_to_cart'] === '32'){
        setcookie($_GET['add_to_cart'], "M&M's cookies", time() + 900);
    }
